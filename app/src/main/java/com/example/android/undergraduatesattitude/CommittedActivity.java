...
public class CommittedActivity extends OptimalActivity {
    ...
    private void generateAdice() {
        ...
        boolean forgetRecommendActivity = true;
        boolean forgetMandatoryActivity = true;
        ...
        switch (this.getPriority()) {
            ...
            case HIGHLY_RECOMMENDED:
                ...
                break;
            case MANDATORY:
                forgetMandatoryActivity = false;
                if (CommittedDuration > maxDuration) {
                    Advice = mandatoryDecreaseAdvice + (CommittedDuration-maxDuration ) + "Hrs to be come better !";
                } else if (CommittedDuration < minDuration) {
                    Advice = mandatoryIncreaseAdvice + (minDuration-CommittedDuration ) + "Hrs to reach better life";
                }
                break;
            default:
                break;
        ...
        if (forgetMandatoryActivity == true) {
           Advice = forgetMandatoryAdvice;
        }
        if (forgetRecommendActivity == true)
        {
